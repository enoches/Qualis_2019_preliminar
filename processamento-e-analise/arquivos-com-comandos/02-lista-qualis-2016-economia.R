...
# Área de Economia 2012-2016 e salva como `qualis_economia_2016.rds`
...
qualis_economia_2016 <- qualis_economia_2016 %>%
...
# Outros:
#qualis_economia_2016 %>% distinct(ESTRATO_2016) %>% arrange(ESTRATO_2016)
# c("A1", "A2", "B1", "B2", "B3", "B4", "B5")
# ?lvls_reorder()
# sort(levels(qualis_economia_2016$ESTRATO_2016))
# order(levels(qualis_economia_2016$ESTRATO_2016)) 