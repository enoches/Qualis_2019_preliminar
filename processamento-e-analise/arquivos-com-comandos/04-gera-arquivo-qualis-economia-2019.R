...
README <- data.frame(
  README = c(
    "Classificação Qualis dos periódicos de Economia para 2019 - Preliminar",
    "",
...
# Pega a planilha ----
qualis_economia_2019 <- read_rds(here::here(
...
write_xlsx(list(README, qualis_economia_2019),
  path = here::here("qualis_economia_2019.xlsx"),
)

# Remove do ambiente os objetos utilizados
rm(README, qualis_economia_2019) 